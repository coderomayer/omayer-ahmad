...
const Home = () => {
  return (
    <section className="p-8 md:p-24 h-screen bg-gradient-to-br from-slate-900 to-zinc-800 darken">
      <div className="text-white">
        <h4 className='text-lime-400 font-mono'>Hi, my name is</h4>
        <h2 className="text-6xl font-Inter font-bold my-3 ">Omayer Ahmad</h2>
